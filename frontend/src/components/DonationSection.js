  ...
  return <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-blue-50 rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            ...
            <div className="p-6">
              <div className="flex items-center mb-4">
                <HeartHandshakeIcon className="h-6 w-6 text-blue-600 mr-2" />
